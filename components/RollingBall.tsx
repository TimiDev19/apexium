...
const RollingBall = () => {
    ...
    return (
        <>
            <div ref={ref} className="pt-[90px] hidden lg:flex relative flex-col items-center justify-center min-h-screen bg-green-700 overflow-hidden py-[10px]">
            ...
            <div ref={ref} className="pt-[90px] lg:hidden flex relative flex-col items-center justify-center min-h-screen bg-green-700 overflow-hidden py-[10px]">
                {/* Text that will be revealed */}
                <AnimatePresence>
                    <motion.h1
                        className={`text-2xl font-bold relative z-10 transition-colors duration-500 ${showText ? "text-black" : "text-green-700"
